...
(function () {
  ...
  const T = {
    es: {
      ...
      profileScenario: (producer) => `Ante un aumento de productividad de <b>1%</b> en ${producer}, el PIB nacional aumenta aproximadamente en:`,
      ...
      infoOwn: "La parte del efecto asociada directamente al productor seleccionado: sus ventas a consumo final interno y sus exportaciones.",
    ...
    en: {
      ...
      profileScenario: (producer) => `Following a <b>1%</b> productivity increase in ${producer}, national GDP increases by approximately:`,
      ...
      infoOwn: "The part of the effect associated directly with the selected producer: its sales to domestic final consumption and its exports.",
